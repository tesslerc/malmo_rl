...
parser.add_argument('--min_max_q_values', default=10.0, type=float,
                    help='All Q values will be normalized to the range of [-val, +val]. A value of 0 disables this normalization')
